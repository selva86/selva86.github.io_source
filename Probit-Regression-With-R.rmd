...
While logistic regression used a cumulative logistic function, probit regression uses a normal cumulative density function for the estimation model. Specifying a probit model is similar to logistic regression. Using the `glm()` function but with `family` argument set to `binomial(link="probit")`.
