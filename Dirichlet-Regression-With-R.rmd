...
More detailed examples are available in the [Dirichlet regression](https://cran.r-project.org/web/packages/DirichletReg/vignettes/DirichletReg-vig.pdf) vignette and details about the implementation are available in [here](http://epub.wu.ac.at/4077/1/Report125.pdf).