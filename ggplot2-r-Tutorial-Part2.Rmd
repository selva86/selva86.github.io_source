...
## Ggplot Tutorial - Part 2: Styling and Manipulating the Output
 ...
 * [Part 2: Styling and Manipulating the Output](ggplot2-r-Tutorial-Part2.html), is about more advanced customizations related to styling the plot elements (like legend, annotations, multiplots with faceting and custom layout, etc) and manipulating the output. 
 
 * [Part 3: Advanced Visualizations with Ggplot2 Geoms. What Chart to Use for Given Objective?](ggplot2-r-Tutorial-Part3.html), applies what we learnt in part 1 and 2 to construct other types of ggplots such as bar charts, boxplots etc.
...
_source: http://docs.ggplot2.org/dev/vignettes/themes.html_
