...
The `polr()` function from the `MASS` package can be used to build the _proportional odds logistic regression_ and predict the class of multiclass ordered variables. One such use case is described below.
...
Also, it is worthhile to note that about 70% of the cars are evaluated as _unacceptable_. The class distribution of the ordered multiclass $Y$ is as follows:
