...
* [Grid lines](ggplot2-Tutorial-With-R.html#6.10 Grid lines)
...
## 2. The Layers
The layers in ggplot2 are also called '_geoms_'. Once the base setup is done, you can append the geoms one on top of the another. The [documentation](http://docs.ggplot2.org/current/) provides a compehensive list of all available _geoms_.
...
The `ggthemes` package provides [additional ggplot](https://github.com/jrnold/ggthemes) themes that imitates famous magazines and softwares. Here is an example of how to change the theme.
