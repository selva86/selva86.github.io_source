...
## 6. Changing axis texts and ticks location.
...
Let's set the `breaks` for Y axis text as well and format the X and Y axis labels. I have used 2 methods for formatting labels: 
  * Using `sprintf()`. (Have formatted it as % in below example)
  * Using a custom user defined function. (Formated 1000's to 1K scale)
