...
VIF is a metric computed for every $X$ variable that goes into a linear model. The higher the VIF, more redundant is that variable. VIF for a $X$ var is calculated as: 
