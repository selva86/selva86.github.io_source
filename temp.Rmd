...
```
## Ggplot Tutorial - Part 3: Advanced Visualizations - What Chart to Use for Given Objective?
 ...
 * [Part 3: The Ggplot2 Geoms - What visualisation to use for given objective?](ggplot2-r-Tutorial-Part3.html), applies what was learnt in part 1 and 2 to construct other types of ggplots such as bar charts, boxplots etc.
...
# Plot
ggplot(email_campaign_funnel, aes(x = Stage, y = Users,  # set data source, X and Y axis columns
                                  fill = Gender)) +   # Fill column
  geom_bar(stat = "identity", width = .6) +   # draw the bars
  scale_y_continuous(breaks = seq(-15000000, 15000000, 5000000),   # X Axis Breaks
                     labels = paste0(as.character(c(seq(15, 0, -5), seq(5, 15, 5))), "m")) +   # X Axis Labels
...
ggplot(df, aes(x=date)) + 
  ...
  labs(title="Time Series of Returns Percentage", subtitle="Drawn from Long Data format", caption="Source: Economics", y="Returns %", color=NULL) +  # title and caption
  scale_x_date(labels = lbls, breaks = brks) +  # change to monthly ticks and labels
...
ggplot(df, aes(x=date)) + 
  ...
  labs(title="Time Series of Returns Percentage", subtitle="From Wide Data format", caption="Source: Economics", y="Returns %") +  # title and caption
  scale_x_date(labels = lbls, breaks = brks) +  # change to monthly ticks and labels
...
chennai_map <- qmap("chennai", zoom=12, source = "osm")  # Open Street Map 

plot(chennai_map)  # Test 

# Lon and Lat for Places
...
# Plot
chennai_map + geom_point(aes(x=lon, y=lat),
                         data = places_loc, 
                         alpha = 0.7, 
                         size = 7, 
                         color = "tomato") + 
...
```
![Spatial Map in Ggplot Ggmap](screenshots/ggplot_masterlist_50.png)
