...
A _stationary time series_ is one whose mean and variance does not change with time. This means it is devoid of trend or seasonal patterns, which makes it looks like a random _white noise_ irrespective of the observed time interval. 
...
plot(ap_seasdiff, type="l", main="Seasonally Differenced")
