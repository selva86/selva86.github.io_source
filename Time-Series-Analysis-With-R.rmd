...
1. Is shows if the previous states (lagged observations) of the time series has an influence on the current state. In the autocorrelation chart below, if the autocorrelation crosses the dashed blue line, it means that specific lag is significantly correlated with current series. For example, in the top-left chart (below), there is significant autocorrelation for all the lags shown in x-axis.
